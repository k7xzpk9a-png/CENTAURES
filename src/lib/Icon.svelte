<!--
  Inline-SVG icon set. Add new icons here by extending the IconName union
  and the paths map. Keeping a single component avoids pulling in an icon
  library (smaller bundle, fewer deps to break on upgrade).

  All paths are 24x24 viewBox Material Design icons (Apache 2.0).
-->
...
<script lang="ts">
  ...
  const paths: Record<IconName, string> = {
    ...
    stats:
      'M19 3H5c-1.11 0-2 .89-2 2v14c0 1.1.89 2 2 2h14c1.11 0 2-.9 2-2V5c0-1.11-.89-2-2-2zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z',
    more_vert:
      'M12 8c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zm0 2c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm0 6c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z',
    delete:
      'M6 19c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V7H6v12zM19 4h-3.5l-1-1h-5l-1 1H5v2h14V4z',
    open: 'M12 4l-1.41 1.41L16.17 11H4v2h12.17l-5.58 5.59L12 20l8-8z',
  };
</script>
